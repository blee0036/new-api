...
type Redemption struct {
	...
	MaxRedeemQuota int            `json:"max_redeem_quota" gorm:"bigint;default:0"` // 最大可用余额额度，0表示不限制
}
...
func (redemption *Redemption) Update() error {
	var err error
	err = DB.Model(redemption).Select("name", "status", "quota", "redeemed_time", "expired_time", "max_redeem_quota").Updates(redemption).Error
	return err
}
