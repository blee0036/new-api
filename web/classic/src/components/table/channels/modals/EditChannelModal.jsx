            ...
            const advancedSettingsContent = (
              <div className='space-y-4'>
                ...
                <div className='pt-3'>
                  ...
                  <Form.Switch field='keep_thinking_model_suffix' label={t('保留思考适配模型后缀')} checkedText={t('开')} uncheckedText={t('关')} onChange={(value) => handleChannelSettingsChange('keep_thinking_model_suffix', value)} extraText={t('直接向上游发送带-thinking等思考适配的模型名。（thinking对应的参数修改依然保留）')} />
